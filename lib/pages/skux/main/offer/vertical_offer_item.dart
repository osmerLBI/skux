...
class VerticalOfferItem extends HookWidget {
  const VerticalOfferItem({Key key, this.item, this.height = 200, this.width = 180, this.scrollDirection}) : super(key: key);
                  ...
                  Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          if (ObjectUtil.isNotEmpty(item['userCard']) && item['userCard']['__typename'] == 'UserCard')
                            Positioned(
                              top: 4,
                              right: 4,
                              child: Container(
